...
class TripPlanner:
    ...
    def plan_trip(self) -> None:
        ...
        if not self.get_human_confirmation("Would you like to use this flight?"):
            print("\nPlease book your preferred flight separately.")
            suggested_flight = {
                "flight_number": "Custom",
                "departure_time": "Custom",
                "arrival_time": "Custom",
                "airline": "Custom"
            }
        ...
        if not self.get_human_confirmation("\nWould you like to use this itinerary?"):
            print("\nPlease plan your activities separately.")
            suggested_itinerary = {
                "day1": ["Custom activities"],
                "day2": ["Custom activities"],
                "day3": ["Custom activities"]
            }
